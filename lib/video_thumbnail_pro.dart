...
//
// To use, import `package:video_thumbnail_pro/video_thumbnail_pro.dart`.
//
// See also:
//
//  * [video_thumbnail_pro](https://pub.dev/packages/video_thumbnail_pro)
//
import 'dart:async';
...
class VideoThumbnailPro {
  ...
  static Future<XFile> thumbnailFile({
    ...
    return VideoThumbnailProPlatform.instance.thumbnailFile(
      video: video,
      headers: headers,
  ...
  static Future<Uint8List> thumbnailData({
    ...
    return VideoThumbnailProPlatform.instance.thumbnailData(
      video: video,
      headers: headers,
      imageFormat: imageFormat,
      maxHeight: maxHeight,
